...
# 1. CONFIGURAÇÕES (Mantendo o CSS de cores Vermelho/Cinza)
...
# 2. MOTOR DE DADOS COM UNIFICAÇÃO DE GESTÃO
...
def load_data():
    try:
        ...
        # --- CORREÇÃO DE UNIFICAÇÃO ---
        # Força qualquer variação de "Operacional" para o nome padrão do PDF
...
# 3. BARRA LATERAL (Com a lógica "Todos" e cores corrigidas)
...
# 4. DASHBOARD (Mantendo a estrutura de cards semafóricos)
...
with aba1:
    if not df.empty:
        ...
        # Filtragem de gastos para os cards
